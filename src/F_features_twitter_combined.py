## Feature extraction: Twitter, tweets combined by user ##
## This is the script we are using to extract features from Twitter data. 
## Has less empath categories + some added features. 
### Takes in twitter_combineduserd.parquet and outputs features_combinedtwitter.parquet
...
if __name__ == "__main__":
    ...
    df_feat.to_parquet("data/features_combinedtwitter.parquet", index=False)
    print(f"Features extracted and saved to data/features_combinedtwitter.parquet. Total rows: {df_feat.shape[0]}")